...
puts "TEST"
arr = [1,3,5,2,4,6]
puts arr.count_inversions == 3

puts "TEST 2"
arr = [1,5,3,2,4]
puts arr.count_inversions == 4

puts "TEST 3"
arr = [5,4,3,2,1]
puts arr.count_inversions == 10

puts "TEST 4"
arr = [1,6,3,2,4,5]
puts arr.count_inversions == 5

puts "TEST 5"
arr = [9, 12, 3, 1, 6, 8, 2, 5, 14, 13, 11, 7, 10, 4, 0]
puts arr.count_inversions == 56
...
puts arr.count_inversions == 2372
